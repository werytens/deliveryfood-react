        ...
        <div className={cl.main}>
            ...
            <div className={cl.right__side}>
                ...
                <div className={cl.actions}>
                    <button className={cl.button} onClick={addOne}>+</button>
                    <div>{count}</div>
                    <button className={cl.button} onClick={removeOne}>-</button>
                    <button className={cl.button} onClick={removeItem}>Remove</button>
                </div>             
            </div>
        </div>
    )
