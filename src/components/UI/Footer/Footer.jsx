        ...
        <div className={cl.main}>
                <div className={cl.left__section}>
                    ...
                    <div className={cl.media__links}>
                        <Link className={cl.media__item} to = '/'>Ресторанам</Link>
                        <Link className={cl.media__item} to = '/'>Курьерам</Link>
                        <Link className={cl.media__item} to = '/'>Пресс-центр</Link>
                        <Link className={cl.media__item} to = '/'>Контакты</Link>
                    </div>
                </div>
