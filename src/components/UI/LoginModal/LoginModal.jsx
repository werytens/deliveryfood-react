...
const LoginModal = ({visible, setVisible}) => {
    ...
    const loginFunction = (e) => {
        ...
        if (loginInfo[0] === '' || usersObject[loginInfo[0]] === undefined || usersObject[loginInfo[0]]["password"] !== loginInfo[1]) {
            let text = '';
            ...
            localStorage.setItem("deliveryfood", JSON.stringify({
                "user": loginInfo[0],
                "basket": ""
            }))
            ...
            <div className={cl.modal__inner} onClick={e => e.stopPropagation()}>
                ...
                <form action="">
                    <div className={cl.inputs}>
                        <LoginInput type = {"text"} callback = {loginInfoAdd}> Введите имя пользователя </LoginInput>
                        <LoginInput type = {"password"} callback = {loginInfoAdd}> Введите пароль </LoginInput>
                    </div>
